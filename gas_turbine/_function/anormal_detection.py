...
def anomaly_detection(variable,power,lower_limit,upper_limit): 
    ...
    #导入稳态模型
    unsteady_model = joblib.load('E:/Python/turbine01/model/unsteady_model.pkl')
    steady_model = joblib.load('E:/Python/turbine01/model/steady_model.pkl')
    steady_ratio = joblib.load('E:/Python/turbine01/model/steady_ratio.pkl')
