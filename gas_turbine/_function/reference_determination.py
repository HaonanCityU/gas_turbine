...
def reference_regression(cl,v,x,y,num):
    ...
    joblib.dump(GLM,'E:/Python/turbine01/model/GLM_{0}_{1}.pkl'.format(cl,v))
    # 贝叶斯线性回归
...
if __name__=='__main__':
    #基准值回归    
    reference = pd.read_csv('E:/Python/turbine01/data/reference_samples_z.csv').drop(columns=['clusters'])
    # 测试样本    
...
# In[2]
    # 标准差回归 
    reference_sd = pd.read_csv('E:/Python/turbine01/data/reference_std_samples_z.csv').drop(columns=['clusters'])
    # 测试样本    
